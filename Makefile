...
$(TABLES_DIR)/tbl-dataset-overview.tex: $(EVAL_GREEDY)
	@mkdir -p $(TABLES_DIR)
...
$(TABLES_DIR)/tbl-main-res-time.tex: $(EVAL_GREEDY_LOOKAHEAD_SEP) $(EVAL_HILLC_RANDOM_SEP) $(EVAL_ANNEAL_RANDOM_SEP)
	@mkdir -p $(TABLES_DIR)
...
$(TABLES_DIR)/tbl-ilp-comp.tex: $(EVAL_ILP_SEP_PRUNED) $(EVAL_ILP_BASELINE_SEP_PRUNED) $(EVAL_ILP_BASELINE) $(EVAL_ILP_BASELINE_SEP) $(EVAL_ILP_BASELINE_PRUNED) $(EVAL_ILP_BASELINE_SEP_PRUNED) $(EVAL_ILP) $(EVAL_ILP_SEP) $(EVAL_ILP_PRUNED)
	@mkdir -p $(TABLES_DIR)
...
$(TABLES_DIR)/tbl-untangling-graph-size.tex: $(EVAL_GREEDY_SEP) $(EVAL_GREEDY_SEP_PRUNED) $(EVAL_GREEDY_SEP_UNTANGLED)
	@mkdir -p $(TABLES_DIR)
...
$(TABLES_DIR)/tbl-untangling-ilp.tex: $(EVAL_ILP_SEP_PRUNED) $(EVAL_ILP_SEP_UNTANGLED) $(EVAL_ILP_PRUNED) $(EVAL_ILP_UNTANGLED)
	@mkdir -p $(TABLES_DIR)
